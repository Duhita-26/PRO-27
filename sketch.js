...
function setup() {
    ...
    bobObject1=new Bob(300,350,55);
    bobObject2=new Bob(350,350,55);
    bobObject3=new Bob(400,350,55);
    bobObject4=new Bob(450,350,55);
	bobObject5=new Bob(500,350,55);
	bobObject5=new Bob(500,350,55);

	ground = new Roof(400,200,300,30);
